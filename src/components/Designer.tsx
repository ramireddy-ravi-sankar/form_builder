...
function Designer() {
  ...
  useDndMonitor({
    onDragEnd:(event:DragEndEvent)=>{
        ...
        const isDrooppingOverDesignerDropArea= over.data?.current?.isDesignerDropArea;

        const droppingSidebarBtnOverDesignerDropArea=
                  isDesignerBtnElement && isDrooppingOverDesignerDropArea;
        ...
        const isDrooppingOverDesignerElement= 
          isDroppingOverDesignerElementTopHalf || isDroppingOverDesignerElementBottomHalf

        const droppingSidebarBtnOverDesignerElement= 
          isDesignerBtnElement && isDrooppingOverDesignerElement;
    ...
    <div className='flex w-full h-full'>
      ...
      >
        <div
          ...
          className={cn(
            "bg-background max-w-[920px] h-full m-auto rounded-xl flex flex-col items-center justify-start flex-grow overflow-y-auto",
